...
fExprOp OpAnd e1 e2 va = e1 Value ++ [BRT 4] ++ [STS $ bool2int True] ++ [BRA $ codeSize (e2 Value) + 2] ++ e2 Value ++ [AND]
fExprOp OpOr  e1 e2 va = e1 Value ++ [BRF 4] ++ [STS $ bool2int False] ++ [BRA $ codeSize (e2 Value) + 2] ++ e2 Value ++ [OR]
